    ...
    "sEmptyTable": "Data menu Belum Ada"
        ...
        "ajax": {
         ...
         "columnDefs": [
         {
            ...
            "targets" : [1],
            "render" : function (data, type, row) {
              return "<a class=\"btn btn-xs btn-info\" href=\"javascript:void(0)\" title=\"Hak Akses Menu\" onclick=\"aksesmenu("+row[1]+")\">Hak Akses Menu</a>  <a class=\"btn btn-xs btn-warning\" href=\"javascript:void(0)\" title=\"Hak Akses SubMenu\" onclick=\"aksessubmenu("+row[1]+")\">Hak Akses SubMenu</a>";
            }
