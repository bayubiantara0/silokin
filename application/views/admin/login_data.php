...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/foto/logo/logo1.png">
</head>
<body class="hold-transition login-page" id="gradien1">

<div class="login-box">
  <div class="login-logo ">
  <img src="<?=base_url();?>assets/foto/logo/logo.png" alt="IMG">
  </div>
  ...
  <div class="card">
    <div class="card-header bg-info" style="text-align: center;">
      <h4>SILOKIN</h4>
      <font size="2"> SISTEM PENGELOLAAN KENDARAAN INVENTARIS</font>
    </div>
