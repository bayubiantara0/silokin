                ...
                <div class="card">
                    <div class="card-header bg-light">
                        ...
                        <div class="text-right">
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="add_brg()" title="Add Kendaraan"><i class="fas fa-plus"></i> Add</button>
                            <button class="btn btn-sm btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown">
                                <i class="fas fa-print"></i> Cetak
                            </button>
                            <ul class="dropdown-menu" role="menu">
                                <a href="<?php echo base_url('cetakmotor') ?>" class="btn btn-sm btn-outline-primary" id="ctk_motor" target="_blank" title="Cetak Motor"><i class="fas fa-download"></i>
                                    Cetak Motor</a><br>
                                <a href="<?php echo base_url('cetakmobil') ?>" class="btn btn-sm btn-outline-primary" id="ctk_mobil" target="_blank" title="Cetak Mobil"><i class="fas fa-download"></i>
                                    Cetak Mobil</a>
                            </ul>
                        </div>
                    </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="tahun" id="tahun" placeholder="Tahun Penerbitan">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group row ">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="nopol" id="nopol" placeholder="Nomor Polisi">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="nomor" id="nomor" placeholder="Nomor Rangka">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="bahan" id="bahan" placeholder="Bahan Bakar">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="pemegang" id="pemegang" placeholder="Pemegang">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="berita" id="berita" placeholder="No Berita Acara">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group row ">
