...
class Cetakstnkmobil extends CI_Controller
{
...
// Line break
        ...
        $pdf->cell(3, 7, ':', 0, 0, 'L');
        $pdf->cell(20, 7, 'Perpanjangan STNK Roda 4', 0, 0, 'L');
        ...
        $pdf->Ln(6);
        $pdf->cell(33, 7, '', 0, 0, 'L');
        $pdf->cell(100, 7, 'Pajak    STNK   Kendaraan   Dinas / Operasional  Roda 4  (Empat)  Dinas  Pemberdayaan', 0, 0, 'J');
        $pdf->Ln(6);
        $pdf->cell(33, 7, '', 0, 0, 'L');
